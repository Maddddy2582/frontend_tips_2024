...
addItem("Laptop", 35000, 160, "", "John", "laptop");
addItem("Mouse", 500, 50, "", "noella", "mouse");
addItem("Microproccesor", 2000, 200, "", "Mitchelle", "microprocesor");
addItem("Arduino", 1000, 70, "", "Robert", "Arduino");
